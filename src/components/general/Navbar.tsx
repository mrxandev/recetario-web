              ...
              {user ? (
                <div className="flex items-center space-x-3 ml-4">
                  <span className="text-gray-300 text-sm">
                    Hola, <span className="text-indigo-400 font-medium">{user.email}</span>
                  </span>
                  <button
                    onClick={handleLogout}
                    className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                  >
                    Cerrar Sesión
                  </button>
                </div>
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-800 border-t border-gray-700">
          ...
          {user ? (
            <div className="border-t border-gray-700 pt-4 mt-4">
              ...
              <button
                onClick={handleLogout}
                className="w-full text-left px-3 py-2 rounded-md text-base font-medium text-red-400 hover:text-red-300 hover:bg-gray-700 transition-all duration-200"
              >
                Cerrar Sesión
              </button>
            </div>
            ...
            <div className="border-t border-gray-700 pt-4 mt-4 space-y-2">
              <Link
                to="/login"
                className="block px-3 py-2 rounded-md text-base font-medium text-indigo-400 hover:text-indigo-300 hover:bg-gray-700 transition-all duration-200"
              >
                Iniciar Sesión
              </Link>
              <Link
                to="/signup"
                className="block px-3 py-2 rounded-md text-base font-medium bg-indigo-600 text-white hover:bg-indigo-700 transition-all duration-200"
              >
                Registrarse
              </Link>
            </div>
